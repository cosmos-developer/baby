...
toml set --toml-path $HOME/.baby/config/app.toml api.address "tcp://0.0.0.0:1340"
...
babyd start --pruning=nothing --log_level $LOGLEVEL --minimum-gas-prices=0.0001ubaby --rpc.laddr tcp://0.0.0.0:1712